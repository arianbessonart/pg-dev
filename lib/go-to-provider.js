...
function getFunctionDefinition() {
  this.editorWatch = atom.workspace.observeActivePaneItem (function (editor) {
      if (typeof atom.workspace.getActiveTextEditor() != 'undefined' && atom.workspace.getActivePaneItem() &&
          atom.workspace.getActivePaneItem().getRootScopeDescriptor().getScopesArray().toString() === 'source.pgsql') {
        var functionName = '';
        var functions = fManager.getFunctions();
